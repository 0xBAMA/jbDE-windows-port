...
public:
	...
	void OnInit () {
		...
		// additional buffer used for autoexposure
			...
			// Image_4F pdfLUT( LUTPath + "Incandescent.png" );
			Image_4F pdfLUT( LUTPath + "MetalHalide.png" );
			// Image_4F pdfLUT( LUTPath + "Flourescent.png" );
			// Image_4F pdfLUT( LUTPath + "LPSodium.png" );
			// Image_4F pdfLUT( LUTPath + "HPMercury.png" );
