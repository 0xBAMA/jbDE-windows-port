...
class Sussudio final : public engineBase { // sample derived from base engine class
public:
	Sussudio() { Init(); OnInit(); PostInit(); }
	~Sussudio() { Quit(); }

	atlasRenderer_t atlasRenderer;
	...
	void OnInit () {
		ZoneScoped;
		{
			...
			shaders[ "Draw" ] = computeShader( "../src/projects/Impostors/Sussudio/shaders/draw.cs.glsl" ).shaderHandle;
